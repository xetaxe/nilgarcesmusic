...
export const metadata: Metadata = {
  ...
  description: 'Música per esdeveniments',
  openGraph: {
    title: 'Nil Garcés - LIVE',
    description: 'Música per esdeveniments',
    images: [
            ...
            <div className="basis-1/2">
              <ul className="mx-auto mt-4 max-w-[70ch] list-inside list-none space-y-4 px-4 text-lg">
                <li>
                  ...
                  clàssica, versions de jazz i pop. Es pot adaptar en funció del
                  lloc i esdeveniment.
                </li>
                <li>
                  <span className="font-semibold">Espais:</span> els més
                  adequats serien lounges, chill-outs, restaurants elegants,
                  recepcions,... llocs on la gent vol relaxar-se o gaudir d'una
                  estona agradable.
                </li>
                <li>
      ...
      <section id="contact" className="px-4 py-12 md:px-6 md:py-20">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-center max-md:flex-col">
          ...
          <p className="text-black2 flex items-center gap-2">
            ...
            <span>Barcelona i voltants</span>
          </p>
        </div>
      </section>
