...
export function Hero() {
  return (
    <div className="w-full bg-bg-400">
      <Container className="relative h-[105vh] flex flex-wrap justify-center sm:justify-between lg:flex-nowrap pt-6">
        ...
        <span className="absolute top-9 right-3 basis-0">
          <a href="">
